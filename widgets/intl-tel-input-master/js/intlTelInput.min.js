...
$(document).ready(function () {
    ...
    //var countryData = $("#ph_no").intlTelInput("getSelectedCountryData");
    
    $(".form-group-wrap-tel-outer .input-control-wrap").intlTelInput();
            $(".form-group-wrap-tel-outer .input-control-wrap").intlTelInput("setCountry", "in");
            var contryCode = ($('.selected-flag').attr('title'));
            $(".form-group-wrap-tel-outer .countryCode").val(contryCode);
            $(".form-group-wrap-tel-outer .input-control-wrap").on("countrychange", function(e, countryData) {
    var contryCode = ($('.selected-flag').attr('title'));
            $(".form-group-wrap-tel-outer .countryCode").val(contryCode);
    });
            $('.intl-tel-input').append('<span class="focus-border-ani"><i></i></span>');
    //alert(countryData);
